...
public class ProductsRepoImpl implements ProductsRepo {
    ...
    @Override
    public int deleteProduct(GetProductIdDto getProductIdDto) {
        return jdbcTemplate.update(DELETE_PRODUCT, getProductIdDto.getId());
    }

    @Override
    public List<Products> getAllProducts() {
        return jdbcTemplate.query(GET_ALL_PRODUCTS, new BeanPropertyRowMapper<>(Products.class));
    }

    @Override
    public Products getProductById(GetProductIdDto productId) {
